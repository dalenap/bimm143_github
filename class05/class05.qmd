...
- the **geom**s that determine how the plot is drawn (lines, points, columns, boxplots, densities, etc.)
...
I can always save any ggplot object (i.e. plot) and then use it later for adding more layers. Geom_smooth (se=FALSE) removes the StDev area.
